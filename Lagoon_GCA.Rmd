...
These data are used to check against the order prey categories are presented in Figure 1.
...
Note: Figure labeling was done outside of R.```{r Combined Plot, echo=TRUE, message=FALSE, warning=FALSE, cache=TRUE, cache.path="cache/"}
