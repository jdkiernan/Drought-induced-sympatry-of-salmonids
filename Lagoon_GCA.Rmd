...
3. Save IRI output - Supplemental Table *S3* in the mansuscript
...
These data are used to check and verify the relative order that the prey categories are presented in Figure 1. They also contribute to Tablse S3 in the manuscript.
...
analyze_diet <- function(data, subset_name, prey_indices) {
  ...
  # Format string for table (prey in alphebetized order)
