---
title: "Explaining gut content analyses (CGA) conducted on Scott Creek Lagoon fish diet data"
...
## Fish Diet Summary (Table S2 in manuscript)
...
These data are used to check and verify the relative order the prey categories are presented in Figure 1.
...
# Step 3: Combine and assign clean color groupings
...
# Step 4: Create transparent dummy links to force the center gap between right and left halves
...
# Step 5: Explicitly define Node order to prevent stacking when iterations = 0
...
# Step 6: Assign Node color groups
nodes <- nodes %>%
  mutate(group = case_when(
...
# Step 7: Map the exact d3 Color Scale
...
# Step 8: Calculate indices and clean up display labels
...
# Step 10: Inject JavaScript for margin labels
library(htmlwidgets)
...
### Create and assemble Figure S1 (NMDS plots)
...
### Figure S1. NMDS Ordination plots
